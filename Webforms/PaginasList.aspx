<%@ Page Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="PaginasList.aspx.vb" Inherits="ListPaginas" title="Vista de Páginas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" style="border-right: whitesmoke thin solid; border-top: whitesmoke thin solid; border-left: whitesmoke thin solid; border-bottom: whitesmoke thin solid">
        <tr>
        <td style="width: 75%;"> 
            <asp:Label ID="lbl_Titulo" runat="server" Text="VISTA GENERAL DE PAGINAS" Width="100%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
            ...
            <td colspan="2" align="center">
                  <telerik:RadGrid ID="Rg_Listado" runat="server" AllowPaging="True" AllowSorting="True" 
                      ...
                      <Columns>
                         ...
                         <telerik:GridBoundColumn DataField="url" EmptyDataText="" 
                             HeaderText="Dirección URL" SortExpression="URL" UniqueName="URL">
                             <ItemStyle  Width="200px"  HorizontalAlign ="Left"/>
                             <HeaderStyle Width="200px" HorizontalAlign ="Center" />                                 
                         </telerik:GridBoundColumn>
                ...
                <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle ="True" >
                 ...
                 <ExportSettings
                   HideStructureColumns="True" FileName ="Paginas" 
