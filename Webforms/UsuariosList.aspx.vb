...
Partial Class ListUsuarios
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListUsuarios As List(Of UsuariosBrl) = UsuariosBrl.CargarTodos()
        Session("ListUsuarios") = ListUsuarios
        Rg_Listado.DataSource = Session("ListUsuarios")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Usuarios.aspx?Refrescar=1&ID=" & item("Id").Text)
    End Sub
