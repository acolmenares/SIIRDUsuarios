...
Partial Class ListPerfiles
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListPerfiles As List(Of PerfilesBrl) = Session("ListPerfiles")

        'si no hay una variable de sesión con la lista.
        If ListPerfiles Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListPerfiles = PerfilesBRL.CargarTodos()
            Session("ListPerfiles") = ListPerfiles
        End If

        Rg_Listado.DataSource = Session("ListPerfiles")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Perfiles.aspx?Refrescar=1&ID=" & item("Id").Text)
    End Sub
