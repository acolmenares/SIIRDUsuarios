<%@ page language="vb" MasterPageFile="~/Controles/MasterPage.master" autoeventwireup="false" codefile="Sucursales.aspx.vb" inherits="Sucursales" Title ="Edición consulta de Sucursales" %>
        ...
        <tr valign="top">
            <td>
                <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                    ...
                    <tr valign="top" >
                        <td  class="LabelCell" style="width: 30%">
                            <asp:Label id="lblDescripcion" runat="server">Nombre de la Sucursal / Regional</asp:Label>
                        </td>
                        <td class="ControlCell" style="width: 70%">
                                <telerik:radtextbox skin="Outlook"  id="txtdescripcion" runat = "server" Width="464px"></telerik:radtextbox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtdescripcion"
                                    ErrorMessage="Falta Nombre Sucursal" EnableClientScript="False">*</asp:RequiredFieldValidator></td>
                    </tr>
                    <tr valign="top">
                            <td class="LabelCell" style="width: 30%;">
                                <asp:Label ID="Label1" runat="server">Código de Enlace de Proyecto Principal</asp:Label></td>
                            <td class="ControlCell" style="width: 70%;">
                                <telerik:radtextbox skin="Outlook"  id="txt_enlace" runat = "server" Width="64px">
                                </telerik:RadTextBox><asp:RequiredFieldValidator ID="rfv_url" runat="server" ControlToValidate="txt_enlace"
                                    ErrorMessage="Falta Código de Enlace" EnableClientScript="False">*</asp:RequiredFieldValidator></td>
                    </tr>
                </table>
            </td>
