<%@ page language="vb" MasterPageFile="~/Controles/MasterPage.master" autoeventwireup="false" codefile="Perfiles.aspx.vb" inherits="Perfiles" Title ="Edición consulta de Perfiles" %>
                ...
                <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                    <tr valign="top">
                        ...
                        <td class="ControlCell" style="width: 70%">
                            ...
                            <asp:regularexpressionvalidator id="revNombre_Completo" runat="server" EnableClientScript="False" ErrorMessage="El valor ingresado para descripción no es válido"  ControlToValidate="txtdescripcion" ValidationExpression=".{0,100}">*</asp:regularexpressionvalidator>
                        ...
                        <tr valign="top">
                            ...
                            <td class="ControlCell" style="width: 70%">
                                <asp:CheckBox ID="chk_Administrador" runat="server" Text="Seleccione esto si este perfil va a manejar el módulo de usuarios." /></td>
                        </tr>
                   </table>
                 </td>
