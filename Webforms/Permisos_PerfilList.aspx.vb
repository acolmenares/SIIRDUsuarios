...
Partial Class ListPermisos_Perfil
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListPermisos_Perfil As List(Of Permisos_PerfilBrl) = Session("ListPermisos_Perfil")

        'si no hay una variable de sesión con la lista.
        If ListPermisos_Perfil Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListPermisos_Perfil = Permisos_PerfilBRL.CargarTodos()
            Session("ListPermisos_Perfil") = ListPermisos_Perfil
        End If

        Rg_Listado.DataSource = Session("ListPermisos_Perfil")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Permisos_Perfil.aspx?Refrescar=1&ID=" & item("Id").Text)
    End Sub
