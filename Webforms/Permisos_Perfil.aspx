<%@ page language="vb" MasterPageFile="~/Controles/MasterPage.master" autoeventwireup="false" codefile="Permisos_Perfil.aspx.vb" inherits="Permisos_Perfil" Title ="Edición consulta de Permisos de Perfil" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="TablaContenido" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
        <tr valign="top">
        <td style="width: 75%"> 
            <asp:Label ID="lbl_Titulo" runat="server" Text="CREACION / MODIFICACION DE PERMISOS POR PERFIL" Width="90%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
                ...
                <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                         <tr valign="top" >
                              <td  class="LabelCell" style="width: 25%; vertical-align: middle; height: 50px; text-align: center;" >
                                <asp:Label id="lblDescripcion" runat="server" CssClass="LabelsDigitar">Nombre del perfil</asp:Label>
                              </td>
                              <td class="ControlCell" style="width: 25%; vertical-align: middle; height: 50px; text-align: center;" >
                                    <asp:dropdownlist id="ddlPerfiles" runat="server" Font-Size="X-Small" CssClass="drop01" Width="90%" ></asp:dropdownlist>        
                                    <asp:requiredfieldvalidator id="rfvId_Perfil" runat="server" EnableClientScript="False" ErrorMessage="Falta la información de Perfil" ControlToValidate="ddlPerfiles">*</asp:requiredfieldvalidator>
                                    <asp:regularexpressionvalidator id="revId_Perfil" runat="server" EnableClientScript="False" ErrorMessage="El valor ingresado para Perfil no es válido"  ControlToValidate="ddlPerfiles" ValidationExpression="(?!0).*">*</asp:regularexpressionvalidator>
                              </td>
