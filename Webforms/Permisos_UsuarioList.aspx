<%@ Page Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="Permisos_UsuarioList.aspx.vb" Inherits="ListPermisos_Usuario" title="Vista de Permisos por Usuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" style="border-right: whitesmoke thin solid; border-top: whitesmoke thin solid; border-left: whitesmoke thin solid; border-bottom: whitesmoke thin solid">
        <tr>
        <td style="width: 75%;"> 
            <asp:Label ID="lbl_Titulo" runat="server" Text="VISTA GENERAL DE PERMISOS POR USUARIO" Width="100%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
        ...
        <tr>
            <td colspan="2" align="center">
                  <telerik:RadGrid ID="Rg_Listado" runat="server" AllowPaging="True" AllowSorting="True" 
                      ...
                      <Columns>
                         <telerik:GridTemplateColumn HeaderText="No." UniqueName="TemplateColumn1" DefaultInsertValue="">
                            <ItemTemplate>
                         ...
                         <telerik:GridBoundColumn DataField="Id" UniqueName="Id" Visible ="False" DefaultInsertValue="" >
                         </telerik:GridBoundColumn>
                        
                         <telerik:GridBoundColumn DataField="Usuarios.Nombre_Completo" EmptyDataText="" 
                             HeaderText="Nombre Usuario" SortExpression="Usuarios.Nombre_Completo" UniqueName="Usuarios.Nombre_Completo" DefaultInsertValue="">
                             <ItemStyle  Width="300px"  HorizontalAlign ="Left"/>
                             <HeaderStyle Width="300px" HorizontalAlign ="Center" />                                 
                         </telerik:GridBoundColumn>

                         <telerik:GridBoundColumn DataField="Paginas.Descripcion" EmptyDataText="" HeaderText="Nombre P&#225;gina" 
                                  SortExpression="Paginas.Descripcion" UniqueName="Paginas.Descripcion" DefaultInsertValue="">
