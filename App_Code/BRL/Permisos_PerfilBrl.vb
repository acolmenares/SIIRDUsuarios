...
Partial Public Class Permisos_PerfilBrl
    ...
    Public Shared Event LoadedPermisos_PerfilList(ByVal target As List(Of Permisos_PerfilBrl), ByVal LoadType As String)
    ...
    Public Shared Function CargarPorID(ByVal ID As Int32) As Permisos_PerfilBrl
