...
Partial Public Class UsuariosBrl
    ...
    Public Shared Event LoadedUsuariosList(ByVal target As List(Of UsuariosBrl), ByVal LoadType As String)
    ...
    Public Shared Event LoadingPorId(ByVal id As String)
    Public Shared Event LoadedPorId(ByVal target As UsuariosBrl)

    Public Shared Function CargarPorID(ByVal ID As String) As UsuariosBrl
    ...
    Public Shared Function CargarPorId_Sucursal(ByVal Id_Sucursal As Int32) As List(Of UsuariosBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of UsuariosBrl)
        RaiseEvent LoadingUsuariosList("CargarPorId_Sucursal")
        dsDatos = UsuariosDAL.CargarPorId_Sucursal(Id_Sucursal)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
        RaiseEvent LoadedUsuariosList(lista, "CargarPorId_Sucursal")
        Return lista
