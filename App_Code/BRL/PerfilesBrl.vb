...
Partial Public Class PerfilesBrl
    ...
    Public Event AdministradorChanging(ByVal Value As Boolean)
    Public Event AdministradorChanged()
    ...
    Public Property Administrador() As Boolean
        ...
        Set(ByVal Value As Boolean)
            If _Administrador <> Value Then
                RaiseEvent AdministradorChanging(Value)
                Me._Administrador = Value
                RaiseEvent AdministradorChanged()
            End If
        End Set
    End Property
    ...
    Public Sub Guardar()
        ...
        If (Me.ID = Nothing) Then
            ...
            Me.ID = PerfilesDAL.Insertar(Descripcion, Administrador)
            RaiseEvent Inserted()
        Else
            RaiseEvent Updating()
            PerfilesDAL.Actualizar(ID, Descripcion, Administrador)
            RaiseEvent Updated()
        End If
