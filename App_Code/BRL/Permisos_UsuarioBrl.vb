...
Partial Public Class Permisos_UsuarioBrl
    ...
    Public Shared Event LoadedPermisos_UsuarioList(ByVal target As List(Of Permisos_UsuarioBrl), ByVal LoadType As String)
    ...
    Public Shared Function CargarPorID(ByVal ID As Int32) As Permisos_UsuarioBrl
